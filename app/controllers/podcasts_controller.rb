class PodcastsController < ApplicationController
  before_action :set_podcast, only: [:show, :edit, :update, :destroy, :test,:start]
  ...
  def start
    CheckPodcastStatusJob.perform_later(@podcast)
    redirect_to @podcast
  end
  ...
  private
    ...
    def podcast_params
      params.require(:podcast).permit(:name, :imageurl, :rss, :color)
    end
end
